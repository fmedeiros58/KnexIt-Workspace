...
export const PLANS: Plan[] = [
  {
    ...
    priceUnit: "BRL",
    oldPrice: "R$40.90",
    priceNote: ["mensais por usuário", "(contrato de um ano)"],
    ctaLabel: "Iniciar agora",
    features: [
      { icon: "drive", title: "30 GB", detail: "de armazenamento em pool por usuário*" },
      ...
      { icon: "check", title: "Controles de segurança e gerenciamento" },
    ],
  },
  {
    id: "standard",
    ...
    features: [
      ...
      { icon: "spark", title: "Converse com a IA no app Gemini e crie sua própria equipe de especialistas" },
      { icon: "video", title: "Videochamadas com gravação, cancelamento de ruído e limite de 150 participantes" },
      { icon: "calendar", title: "Páginas de agendamento de horário" },
      { icon: "doc", title: "Assinatura eletrônica no Google Docs e em PDFs" },
      { icon: "check", title: "Ferramenta Google Workspace Migrate para migração de dados" },
    ],
  },
  {
    id: "plus",
    ...
    features: [
      ...
      { icon: "video", title: "Videochamadas com controle de presença, limite de 500 participantes" },
      { icon: "check", title: "Vault para retenção, arquivamento e pesquisa de dados" },
      { icon: "check", title: "LDAP seguro" },
      { icon: "check", title: "Gerenciamento avançado de endpoints" },
      { icon: "check", title: "Controles aprimorados de segurança e gerenciamento" },
    ],
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "Entre em contato com a equipe de vendas para saber os preços",
    ctaLabel: "Fale com a equipe de vendas",
    features: [
      { icon: "drive", title: "5 TB", detail: "ou faça upgrade para ter mais*" },
      { icon: "mail", title: "E-mail comercial personalizado", detail: "+ Criptografia S/MIME" },
      { icon: "video", title: "Videochamadas com transmissão ao vivo no domínio, limite de 1.000 participantes" },
      { icon: "check", title: "Prevenção contra perda de dados (DLP)" },
      { icon: "check", title: "Acesso Baseado no Contexto (CAA)" },
      { icon: "check", title: "Regiões de dados corporativas" },
      { icon: "check", title: "Cloud Identity Premium" },
      { icon: "check", title: "Gerenciamento corporativo de endpoints" },
      { icon: "check", title: "Classificação por IA para o Google Drive" },
      { icon: "check", title: "Assured Controls disponível como um complemento" },
      { icon: "check", title: "Suporte avançado com respostas mais rápidas para problemas críticos" },
    ],
  },
];
...
const ICONS = {
  ...
  kanban: {
    ...
    path: (
      <path
        fill="currentColor"
        d="M5 5h14v14H5V5Zm2 2.5v9h2v-9H7Zm4 0v4h2v-4h-2Zm4 0v6.5h2v-6.5h-2Z"
      />
    ),
  },
    ...
    path: (
      <>
        ...
        <path
          fill="white"
          fillOpacity="0.9"
          d="M7.2 14.3h3.3c.3 0 .58.26.58.58v2.5c0 .32-.28.58-.58.58H7.2c-.32 0-.58-.26-.58-.58v-2.5c0-.32.26-.58.58-.58Z"
        />
  ...
  hub: {
    ...
    path: (
      <>
        ...
        <path
          d="M8.2 12.6 10.7 8.9M15.9 12.6 13.3 8.9M10.2 13.9l3.6.2"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
        ...
        <path
          d="m7.6 15.5 3 1.8m2.7 0 3.2-1.8"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
  ...
  search: {
    ...
    path: (
      <path
        fill="currentColor"
        d="M11 4a7 7 0 1 1 0 14 7 7 0 0 1 0-14Zm0 2a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm5.5 11.1 3.4 3.4-1.4 1.4-3.4-3.4 1.4-1.4Z"
      />
    ),
  },
    ...
    path: (
      <>
        ...
        <g fill="currentColor">
          ...
          <path
            d="M12 11.2c.4.5.6 1 0 1.6-.6.6-1.4.6-2 0-.6-.6-.4-1.1 0-1.6.4-.5 1.2-.5 2 0z"
            fill="currentColor"
          />
        </g>
      </>
    ...
    path: (
      <>
        ...
        <path
          fill="white"
          fillOpacity="0.9"
          d="M8.5 8.5h7v1.5h-7v-1.5Zm0 2.5h7v1h-7v-1Zm0 1.8h5v1h-5v-1Z"
        />
        <path
          fill="white"
          fillOpacity="0.8"
          d="M15 12.5 18 10l1.4 1.4L16.4 13.9Z"
          stroke="currentColor"
          strokeWidth="0.8"
        />
      </>
...
const APPS: AppHighlight[] = [
  { name: "VioClass", slug: "vioclass", icon: "play", detail: "Plataforma de cursos e aulas em vídeo." },
  { name: "VioLive", slug: "violive", icon: "live", detail: "Aulas ao vivo e mentorias síncronas." },
  { name: "VioRecord", slug: "viorecord", icon: "record", detail: "Grave tela, webcam e voz no navegador." },
  { name: "VioStudio", slug: "viostudio", icon: "edit", detail: "Edição online de vídeo e legendas." },
  { name: "VioAnalytics", slug: "vioanalytics", icon: "analytics", detail: "Métricas de visualização e engajamento." },
  { name: "VioHub", slug: "viohub", icon: "hub", detail: "Produção audiovisual integrada e entrega." },
  ...
  { name: "KnexReview", slug: "knexreview", icon: "review", detail: "Revisão sistemática de literatura." },
  ...
  { name: "KnexAI", slug: "knexai", icon: "owl", detail: "Camada unificada de IA e assistentes." },
  {
    ...
    slug: "knexwriter",
    icon: "pen",
    detail: "Escrita assistida por IA com projetos, seções e paginação A4.",
  },
  { name: "KnexMail", slug: "knexmail", icon: "mail", detail: "E-mails transacionais e campanhas." },
...
export default function PlansSection() {
  ...
  return (
    <section id="planos" className="bg-[var(--kx-bg)] pt-14 pb-0">
      <div className="mx-auto max-w-6xl space-y-7 px-4 md:px-6">
        <div className="space-y-8 text-center">
          <h2 className="mx-auto max-w-5xl px-6 text-center font-[family:Arial,Helvetica,sans-serif] text-[clamp(1.75rem,5.6vw,2.75rem)] font-bold leading-tight text-slate-900 sm:px-10 md:px-16">
        ...
        <div className="flex w-full flex-wrap items-center justify-center gap-3 lg:h-[208px] lg:flex-nowrap lg:items-start lg:justify-between lg:gap-0">
          {APPS.map((app) => (
            <a
              key={app.slug}
              href={`/landing-produtos/${app.slug}`}
              className="group relative flex flex-col items-center gap-1 no-underline transition hover:no-underline focus:no-underline lg:w-12 lg:shrink-0 lg:justify-start lg:transition-[width] lg:duration-200 lg:hover:z-10 lg:hover:w-36"
            >
