...
const PRODUCTS = [
  { name: "SupaDrive", color: "bg-blue-50 text-blue-700" },
  ...
  return (
    <main className="min-h-screen bg-[var(--kx-bg)] text-[var(--kx-ink)] font-[family:Arial,Helvetica,sans-serif]" style={theme}>
      ...
      <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="flex justify-end">
              <div className="relative" ref={menuRef}>
                ...
                {menuOpen && (
                  <div
                    role="menu"
                    className="absolute right-0 mt-3 w-[320px] rounded-3xl border border-slate-200 bg-[#eef3f8] p-5 shadow-[0_20px_60px_-35px_rgba(15,23,42,0.6)]"
                  >
                    ...
                    <div className="mt-4 flex flex-col items-center text-center">
                      ...
                      <button
                        type="button"
                        className="mt-3 inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50"
                      >
                    ...
                    <div className="mt-5 grid grid-cols-2 overflow-hidden rounded-2xl border border-slate-200 bg-white">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-3 text-xs font-semibold text-slate-700 hover:bg-slate-50"
                      >
                        <PlusIcon />
                        Adicionar conta
                      </button>
                      <button
                        ...
                        className="flex items-center justify-center gap-2 border-l border-slate-200 px-3 py-3 text-xs font-semibold text-slate-700 hover:bg-slate-50"
                      >
                        <ExitIcon />
                        Sair
                      </button>
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-10 px-5 py-12 lg:grid-cols-[1.05fr,0.95fr] lg:items-center">
          <section className="space-y-6 fade-up">
            <div className="flex flex-wrap gap-2">
              {PRODUCTS.map((product) => (
                <span
                  key={product.name}
                  className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-semibold ${product.color}`}
                >
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-slate-500">Acesso KnexIT</p>
              <h1 className="mt-3 text-4xl font-semibold leading-tight md:text-5xl">
                Vamos começar
              </h1>
              <p className="mt-3 max-w-xl text-base text-[var(--kx-muted)]">
                Centralize seus produtos, permissões e equipes em uma única conta. Escolha como você quer entrar no
                KnexIT Workspace.
              </p>
            </div>

            <div className="rounded-3xl border border-[var(--kx-border)] bg-[var(--kx-card)] p-6 shadow-[0_24px_50px_-30px_rgba(15,23,42,0.4)]">
              ...
              <Link
                ...
                className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-[var(--kx-primary)] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 hover:brightness-110 no-underline hover:no-underline"
              >
            ...
            <div className="rounded-3xl border border-[var(--kx-border)] bg-white/80 p-5 backdrop-blur">
              ...
              <div className="mt-4 flex items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white px-4 py-3">
                ...
                <button
                  ...
                  className="rounded-full border border-slate-300 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 no-underline hover:no-underline"
                >
          ...
          <section className="fade-up delay-1 flex flex-col items-center justify-center text-center pt-56 md:pt-72 lg:pt-80">
            <div className="space-y-3 text-center max-w-md">
              <h2 className="text-3xl font-semibold">
                Produtividade, conteúdo e comunicação em um único fluxo
              </h2>
              <p className="text-sm text-[var(--kx-muted)]">
                O KnexIT Workspace conecta SupaDrive, VioClass e KnexAI para que seus times planejem, entreguem e
                acompanhem resultados em tempo real.
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/knexit-workspace#produtos"
                  className="inline-flex items-center justify-center rounded-full border border-slate-300 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 no-underline hover:no-underline"
                >
                  Ver produtos
                </Link>
                <Link
                  href="/knexit-workspace#contato"
                  className="inline-flex items-center justify-center rounded-full bg-[var(--kx-secondary)] px-4 py-2 text-xs font-semibold text-white hover:brightness-110 no-underline hover:no-underline"
                >
                  Falar com a equipe
                </Link>
              </div>
