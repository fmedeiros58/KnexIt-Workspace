...
export default function UpConectSalaPage({ params }: { params: { code: string } }) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-white/70 backdrop-blur pointer-events-none">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center gap-3">
          <LogoUpConect className="h-8 w-8 pointer-events-auto" />
        ...
        {!joined ? (
                ...
                <div className="absolute inset-0 grid place-items-center bg-slate-900/70 text-white">
                  <div className="text-center">
                    <div className="mx-auto mb-4 h-16 w-16 rounded-2xl overflow-hidden">
                      <LogoUpConect className="h-16 w-16" />
                    </div>
          ...
          >
            <TopBar
              ...
              screenOn={screenOn}
              onLeave={() => (window.location.href = "/upconect")}
            />
            <VideoGrid />
            <BottomBar
              micOn={micOn}
