...
function makeRoomLink() {
  ...
  return `${origin}/upconect/sala/${code}`;
}

/* ===========================
   Página
=========================== */
export default function UpConectPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed inset-x-0 top-0 z-[75] pointer-events-none">
        <div className="pl-4 pr-4 pt-4 flex items-center gap-3">
          ...
          {/* Logo */}
          <LogoUpConect className="h-10 w-10 shrink-0 pointer-events-auto" />
      ...
      <section className="mx-auto max-w-4xl px-6 pt-20">
        ...
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">
            Conecte-se, colabore e comemore em qualquer lugar com o UpConect
          </h2>
              ...
              {menuOpen && (
                <div className="absolute left-0 mt-2 w-[280px] rounded-2xl bg-white ring-1 ring-slate-200 shadow-xl overflow-hidden text-left">
                  ...
                  <MenuItem
                    ...
                    title="Agendar no UpConect Agenda"
      ...
      <section className="mx-auto max-w-5xl px-6 py-10">
        {tab === "reunioes" ? (
          ...
          <EmptyCard
            title="Ligações"
            desc="Faça e receba ligações diretamente no UpConect (em breve)."
          />
        )}
      </section>
            ...
            <div className="absolute right-0 mt-2 w-72 rounded-xl bg-white ring-1 ring-slate-200 shadow-2xl overflow-hidden">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-slate-50">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    Envie uma ideia para melhorarmos o UpConect.
                  </div>
                </div>
              </button>
            </div>
  ...
  return (
    <div className="rounded-none ring-1 ring-slate-200 bg-white p-10 text-center shadow-sm">
      <div className="mx-auto h-16 w-16">
        <LogoUpConect className="h-16 w-16 mx-auto" />
      </div>
...
=========================== */
const APPS = [
  { title: "UpConect", href: "/upconect", bg: "bg-white", icon: <LogoUpConect className="h-6 w-6" /> },
  // ⬇️ link correto da Agenda
  { title: "Agenda", href: "/upconect/agenda", bg: "bg-blue-100", icon: <IconCalendar className="h-5 w-5" /> },
  ...
  { title: "Drive", href: "https://drive.google.com/drive/", external: true, bg: "bg-yellow-100", icon: <span className="text-[16px]">📁</span> },
];
