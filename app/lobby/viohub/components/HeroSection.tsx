    ...
    <section className="bg-gradient-to-b from-slate-50 to-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-16 pt-12 md:flex-row md:items-center md:justify-between md:px-6">
        <div className="space-y-4 md:w-1/2">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-orange-600">Produto</p>
        ...
        <div className="md:w-1/2">
          <div className="rounded-3xl border border-slate-200 bg-white shadow-lg p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="text-sm font-semibold text-slate-900">Pipeline unificado</div>
              <span className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">Disponível</span>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-orange-50/60 p-4 space-y-2 text-sm text-slate-700 leading-relaxed">
              <p>Conduza roteiros, revisões e entregas em um só lugar, com publicação conectada ao SupaDrive.</p>
              <p className="font-semibold text-slate-900">Dica:</p>
              <p>Use “Acessar produto” para ir direto à área autenticada; o branding traz visão geral e posicionamento.</p>
            </div>
          </div>
        </div>
      </div>
