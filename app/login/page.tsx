...
export default function LoginPage() {
  ...
  // Captura redirect de query; fallback = página de planos
  ...
  // Redireciona quando logado (após OAuth / link mágico / confirmação de e-mail)
  useEffect(() => {
  ...
  return (
    <div className="min-h-[100svh] bg-neutral-50 text-neutral-900">
            ...
            <form onSubmit={handleSignup} className="grid grid-cols-1 gap-3">
              ...
              <label className="text-sm">
                ...
                <p className="mt-1 text-xs text-neutral-500">
                  Mínimo de 6 caracteres · 1 letra · 1 número
                </p>
              </label>
      ...
      {/* Barra inferior com selos/segurança/contato */}
