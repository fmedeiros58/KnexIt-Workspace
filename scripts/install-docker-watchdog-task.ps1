...
try {
  ...
  $taskCommand = "powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File `"$scriptPath`" -IntervalSeconds $IntervalSeconds -DisableVllmWatch -DisableEmbeddingsWatch -DisableKubernetesWatch"
