...
AI_SYSTEM_ANM_CHECKPOINT_DIR="${AI_SYSTEM_ANM_CHECKPOINT_DIR:-data/checkpoints}"
...
AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS="${AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS:-14}"
...
print_effective "AI_SYSTEM_ANM_CHECKPOINT_DIR" "$AI_SYSTEM_ANM_CHECKPOINT_DIR"
...
print_effective "AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS" "$AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS"
...
if ! [[ "$AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS" =~ ^[0-9]+$ ]] || [[ "$AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS" -le 0 ]]; then
  fail "AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS invalido: $AI_SYSTEM_ANM_CHECKPOINT_RETENTION_DAYS"
fi
...
check_dir_writable_or_creatable "Checkpoint AI_SYSTEM_ANM" "$AI_SYSTEM_ANM_CHECKPOINT_DIR"
