export const content = {
  ...
  problems: [
    "Conte̼dos espalhados entre aulas, arquivos e chats.",
  ...
  features: [
    "Busca federada planejada em Drive, Docs, aulas e chats.",
            "Base para ranking sem̢ntico + palavras-chave.",
            "Integra̤̣o futura com KnexAI para sugest̵es e reformula̤̣o.",
  ],
  audiences: [
    "Alunos e professores", "Pesquisadores", "Times internos"
  ],
};
