"""
FILE: memory/global_value.py
RESPONSIBILITY: RAM partition for global_value memory signals.
...
class GlobalValueStore:
    """
    Objective:
        Maintain partition-specific RAM state for global_value.
    Responsibilities:
    ...
    def write(self, key: str, value: Any) -> None:
        ...
        audit_log(component="memory.global_value", event="write", payload={"key": key})
    ...
    def restore_state(self, payload: Dict[str, Any]) -> None:
        ...
        audit_log(component="memory.global_value", event="restore_state", payload={"size": len(self.data)})
