    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-6xl px-4 py-14 space-y-8">
        <header className="space-y-3 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-indigo-600">Branding</p>
          <h1 className="text-3xl md:text-4xl font-bold">Páginas de produto</h1>
          <p className="text-lg text-slate-600">
            Explore as páginas de branding para cada produto e siga para o lobby ou app conforme necessário.
          </p>
        </header>
          ...
          {PRODUCTS.map((p) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-semibold text-indigo-600">Branding</span>
              </div>
        ...
        <div className="text-center text-sm text-slate-600">
          Quer acessar direto o produto? Vá pelo lobby em <Link href="/lobby" className="text-indigo-600 font-semibold">/lobby</Link>.
        </div>
      </div>
    </main>
  );
