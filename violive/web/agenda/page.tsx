// app/VioLive/agenda/page.tsx
import Link from "next/link";

export const metadata = {
  title: "Agenda - VioLive",
  description: "Agendamentos e convites do VioLive (em breve).",
};

export default function VioLiveAgendaPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header simples da página (sem navbar global) */}
      <header className="mx-auto max-w-5xl px-6 py-6 flex items-center gap-4">
        <LogoVioLive className="h-10 w-10" />
        <div>
      ...
      <main className="mx-auto max-w-5xl px-6 pb-16">
        <div className="rounded-3xl ring-1 ring-slate-200 bg-white p-10 text-center shadow-sm">
          <p className="text-slate-600">
            Aqui aparecerá sua agenda de reuniões, integrações com convites e
            links.
          </p>
