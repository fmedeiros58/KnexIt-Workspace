...
export function handoffReflectiveToInferential(state: ProcessingState): ProcessingState {
  ...
  state.reflectiveNotes = {
    assumptions: sanitizeStringArray(state.reflectiveNotes.assumptions, 16),
    caveats: sanitizeStringArray(state.reflectiveNotes.caveats, 16),
    tensions: sanitizeStringArray(state.reflectiveNotes.tensions, 16),
  };
