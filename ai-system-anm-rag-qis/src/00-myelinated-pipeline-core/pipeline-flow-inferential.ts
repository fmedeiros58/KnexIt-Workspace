...
import { runInferentialLayer } from "../08-inferential-layer/inferential-layer-bridge";
...
export async function runInferentialFlow(state: ProcessingState, route: PipelineRoute) {
  ...
  await runInferentialLayer(state);
