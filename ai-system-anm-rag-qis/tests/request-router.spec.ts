 ...
 * - Garantir roteamento tecnico curto para rota minima (clarificacao).
...
assert(routeRequest(shortTechnical) === "minimum", "short technical imperative should use minimum route");
