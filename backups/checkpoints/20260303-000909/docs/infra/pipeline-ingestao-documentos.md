...
- Parser inicial cobre formatos basicos: `txt`, `md`, `csv`, `json`, `docx`, `pdf`.
- Para `pdf`, o pipeline extrai camada textual; PDFs apenas escaneados podem resultar em `INGEST_EMPTY_TEXT` (OCR nao incluido no MVP).
